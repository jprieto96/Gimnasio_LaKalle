 ...
 * 
 */
package presentacion.aula.bajaAula;
...
public class VistaBajaAula extends JFrame implements Vista {
	...
	public void initComponents() {
		...
		panelSur = new JPanel();
		labelBienvenida = new JLabel("Baja de Aula");
		...
		botonOK.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				if (comprobacionSintacticaDatos())
					Controlador.getInstancia().accion(Evento.BAJA_AULA, Integer.valueOf(textoId.getText()));
			}
		});
	...
	public void actualizar(int evento, Object object) {
		switch (evento) {
		case Evento.BAJA_AULA_OK:
			JOptionPane.showMessageDialog(null, "Aula " + (Integer) object + " dada de baja correctamente.");
			break;
		case Evento.BAJA_AULA_ERROR:
			JOptionPane.showMessageDialog(null, "El aula seleccionada no existe o esta impartiendo clases",
