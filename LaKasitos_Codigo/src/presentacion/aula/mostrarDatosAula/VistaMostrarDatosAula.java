 ...
 * 
 */
package presentacion.aula.mostrarDatosAula;
...
public class VistaMostrarDatosAula extends JFrame implements Vista {
	...
	public void actualizar(int evento, Object object) {
		switch (evento) {
		case Evento.MOSTRAR_AULA_POR_ID_OK:
			TAula aula = (TAula) object;
			JOptionPane.showMessageDialog(null, aula.toString());
			break;
		case Evento.MOSTRAR_AULA_POR_ID_ERROR:
			JOptionPane.showMessageDialog(null, "No existen aulas con ese ID", "Mensaje de Error",
	...
	public void initComponents() {
		...
		panelSur = new JPanel();
		labelBienvenida = new JLabel("Mostrar datos de Aula por ID");
		...
		botonOk.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				if (comprobacionSintacticaDatos())
					Controlador.getInstancia().accion(Evento.MOSTRAR_AULA_POR_ID,
							new TAula(Integer.valueOf(textoId.getText()), 0, false));
			}
