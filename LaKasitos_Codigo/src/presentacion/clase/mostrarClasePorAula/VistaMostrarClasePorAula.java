 ...
 * 
 */
package presentacion.clase.mostrarClasePorAula;
...
public class VistaMostrarClasePorAula extends JFrame implements Vista {
	...
	public VistaMostrarClasePorAula() {
		...
		botonOk.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				try {
					...
					Controlador.getInstancia().accion(Evento.MOSTRAR_CLASE_POR_AULA, new TClase(id, -1));
	...
	public void actualizar(int evento, Object object) {
		// begin-user-code
		switch (evento) {
		case Evento.MOSTRAR_CLASE_POR_AULA_OK:
			...
			JOptionPane.showMessageDialog(null, datosClases, "Clases por Aula", JOptionPane.INFORMATION_MESSAGE);
			break;
		case Evento.MOSTRAR_CLASE_POR_AULA_ERROR:
			JOptionPane.showMessageDialog(null, "No hay clases impartidas en el Aula " + (Integer) object,
	...
	public void initComponents() {
		...
		panelSur = new JPanel();
		labelBienvenida = new JLabel("Mostrar datos de Clase por Aula");
		labelId = new JLabel("Introduce ID del Aula: ");
