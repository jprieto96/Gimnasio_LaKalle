 ...
 * 
 */
package presentacion.matricula.mostrarMatriculasPorCliente;
...
public class VistaMostrarMatriculasPorCliente extends JFrame implements Vista {
	...
	public VistaMostrarMatriculasPorCliente() {
		...
		botonOk.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				try {
					...
					Controlador.getInstancia().accion(Evento.MOSTRAR_MATRICULA_POR_ID_CLIENTE, new Integer(id));
	...
	public void actualizar(int evento, Object object) {
		// begin-user-code
		switch (evento) {
		case Evento.MOSTRAR_MATRICULA_POR_ID_CLIENTE_OK:
			...
			JOptionPane.showMessageDialog(null, datosMatriculas, "Matriculas Por Cliente", JOptionPane.INFORMATION_MESSAGE);
			break;
		case Evento.MOSTRAR_MATRICULA_POR_ID_CLIENTE_ERROR:
			JOptionPane.showMessageDialog(null, "No hay matriculas por el cliente " + (Integer) object,
	...
	public void initComponents() {
		...
		panelSur = new JPanel();
		labelBienvenida = new JLabel("Mostrar Matriculas por Cliente");
